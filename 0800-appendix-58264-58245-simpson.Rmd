...
\@ref(tab:tab-culvert-bcfp-58245) - \@ref(tab:tab-culvert-bcfp-58264). A map of the watershed is provided in
map attachment
...
At the time of assessment, the downstream crossing on Lake Kathlyn Road was unlikely a barrier to fish passage. However, should restoration activities proceed, replacement with a bridge spanning `r fpr::fpr_my_pscis_info(site = my_site, col_pull = recommended_diameter_or_span_meters)` m is recommended. At the time of reporting in 2025, the estimated cost for the replacement is \$ COMMENTED OUT BELOW.
...
my_caption1 = paste0('Steelhead spawning location downstream of PSCIS crossing ', my_site2, ', as reported by the adjacent landowner.')
