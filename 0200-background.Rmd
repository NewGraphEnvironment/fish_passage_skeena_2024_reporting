...
```{r hydrology-morice, fig.cap = 'Hydrograph for Morice River near outlet of Morice Lake (Station #08ED002). Available mean daily discharge data from 1961 to 2023.', eval=T}
# get date range for figure caption
