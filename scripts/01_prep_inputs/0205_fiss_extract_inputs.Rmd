...
```{r params}
# path to claened form_fiss_site
path_form_fiss_site_raw <- fs::path('~/Projects/gis/sern_skeena_2023/data_field/2024/form_fiss_site_2024.gpkg')

#NEW geopcackage path for the form after we have added columns as per this script
path_form_fiss_site_complete <- fs::path('~/Projects/gis/sern_skeena_2023/data_field/2024/form_fiss_site_2024_complete.gpkg')
```
...
form_fiss_site_prep3 |> 
  sf::st_write(dsn = path_form_fiss_site_complete,
               append = FALSE,
               delete_dsn = TRUE)
...
fpr::fpr_sp_gpkg_backup(
  path_gpkg = path_form_fiss_site_complete,
  dir_backup = "data/backup/",
  update_utm = TRUE,
  update_site_id = FALSE,
  write_back_to_path = FALSE,
