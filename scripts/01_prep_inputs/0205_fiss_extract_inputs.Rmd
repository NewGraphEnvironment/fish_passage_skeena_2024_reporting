...
Add columns to `form_fiss_site_2024` and then burn back to geopackage
...
MOVED FROM 0200_fiss_site_tidy.Rmd. NEED TO UPDATE

add crew_members = toupper(crew_members)) |>
