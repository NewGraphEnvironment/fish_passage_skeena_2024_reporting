...
In 2024, all field activities since 2020 — including fish passage assessments, habitat confirmation assessments, fish sampling, drone imagery collection, engineering design, remediations, and effectiveness monitoring were consolidated into a centralized interactive table to enable multi-criteria querying (e.g. by watershed group, stream name, road name, PSCIS ID, top ranking sites by watershed group) linking directly to supporting project documentation. While a preliminary ranking of the top five remediation priorities by watershed group is provided, these are inherently subjective and contingent on the capacity and willingness of infrastructure owners and tenure holders to invest in implementation - both financially and in terms of capacity spanning the many years it
can take to see projects from concept through to restoration. Often we are needing to act opportunistically and persue
less expensive and complicated options in order to keep moving and achieve progress in the short term.
